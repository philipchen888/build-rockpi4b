...
dd if=../rootfs-ubuntu-focal/linaro-esp.img of=${BOOT} bs=4096 seek=4096 conv=notrunc,fsync
dd if=../rootfs-ubuntu-focal/linaro-rootfs.img of=${BOOT} bs=4096 seek=135168 conv=notrunc,fsync
